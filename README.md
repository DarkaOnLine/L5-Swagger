...
:-----------------|:----------|:---------------------------|:----------
 7.0.x            | 3         | 3.0                        | `composer require "darkaonline/l5-swagger"`<br><br>Multi API documentation support<br><br>[See changes](#Changes in 8.0)<br><br>[See migration instructions](#migrate-from-<70-to-80)
